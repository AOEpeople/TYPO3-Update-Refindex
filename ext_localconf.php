...
if (TYPO3_MODE == 'BE') {
	...
	$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['scheduler']['tasks'][\Aoe\UpdateRefindex\Scheduler\UpdateRefIndexTask::class] = array (
		...
		'title'            => 'LLL:EXT:update_refindex/Resources/Private/Language/locallang_db.xml:scheduler_task_updateRefindex.name',
		'description'      => 'LLL:EXT:update_refindex/Resources/Private/Language/locallang_db.xml:scheduler_task_updateRefindex.description',
